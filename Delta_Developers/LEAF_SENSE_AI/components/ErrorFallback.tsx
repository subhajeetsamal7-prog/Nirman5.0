  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        >
          <Feather name="alert-triangle" size={48} color={primaryColors.primary} />
        </View>
        ...
        <ThemedText type="body" style={styles.message}>
          LeafSense AI encountered an issue. Please restart the app to continue
